            ...
            <React.Fragment>
                ...
                {this.state.openEnquiries.map((item)=> 
                                ...
                                <Col sm="9"  className="col-xs-12">
                                    <div className="imageinlist" > 
                                        ...
                                        <div>
                                            ...
                                            <div noGutters={true} >
                                                <Col className="lesmallEnqid bold mt150">
                    ...
                    <Col className="col-xs-1"></Col>
                        ...
                        <Row noGutters={true}>
                            <Col className="col-sm-8 col-xs-12 leEnqstatus bold">
                ...
                <Col className="col-xs-12 col-sm-10">
                   <Row noGutters={true}>
                    ...
                    <Col className="col-xs-1"></Col>
                        ...
                        <Row noGutters={true}>
                            <Col className="col-sm-8 col-xs-4 leEnqstatus bold">
                            {this.props.t("Pages.object.Order Status")}
                            </Col>
  ...
  <div className="GreyoutCR">  Change Request  </div>
            ...
            <Col className="col-xs-1"></Col>
              ...
              ></img>
                ...
                <Container>
                    <Row noGutters={true}>
                        <Col className='col-xs-12 text-center mt150 font20'>
                                        Loading Please wait..
                        </Col>
                    </Row>
