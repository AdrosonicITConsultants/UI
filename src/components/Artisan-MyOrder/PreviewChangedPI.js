...
<td className="tdmarginleft">
     ...
     -Yarn: {this.state.yarns[this.state.previewPI.productHistory.warpYarnId-1]?this.state.yarns[this.state.previewPI.productHistory.warpYarnId-1].yarnDesc:""} x {this.state.yarns[this.state.previewPI.productHistory.weftYarnId-1]?this.state.yarns[this.state.previewPI.productHistory.weftYarnId-1].yarnDesc:""}
      ...
      {this.state.dyes[this.state.previewPI.productHistory.weftDyeId-1]?this.state.dyes[this.state.previewPI.productHistory.weftDyeId-1].dyeDesc:""}
    ...
    <p className="descyarnpi wraptext">
     -Yarn: {this.state.yarns[this.state.previewPI.buyerCustomProductHistory.warpYarnId-1]?this.state.yarns[this.state.previewPI.buyerCustomProductHistory.warpYarnId-1].yarnDesc:""}
     x {this.state.yarns[this.state.previewPI.buyerCustomProductHistory.weftYarnId-1]?this.state.yarns[this.state.previewPI.buyerCustomProductHistory.weftYarnId-1].yarnDesc:""} 
     ...
     {this.state.previewPI.buyerCustomProductHistory.extraWeftYarnId? this.state.yarns[this.state.previewPI.buyerCustomProductHistory.extraWeftYarnId-1].yarnDesc: ""} <br/>
      -Yarn Count: {this.state.previewPI.buyerCustomProductHistory?this.state.previewPI.buyerCustomProductHistory.warpYarnCount:""} x
       {this.state.previewPI.buyerCustomProductHistory?this.state.previewPI.buyerCustomProductHistory.weftYarnCount:""}
       {this.state.previewPI.buyerCustomProductHistory.extraWeftYarnCount ? "x":""} {this.state.previewPI.buyerCustomProductHistory.extraWeftYarnCount ? this.state.previewPI.buyerCustomProductHistory.extraWeftYarnCount:""} <br/>
      -Dye Used: {this.state.dyes[this.state.previewPI.buyerCustomProductHistory.warpDyeId-1]?this.state.dyes[this.state.previewPI.buyerCustomProductHistory.warpDyeId-1].dyeDesc:""} x
...
<>
  <td >
     <p className="snopi wraptext">{this.props.hsn}</p>
     </td>
     <td >
...
<h3 className="snopi wraptext">{(this.state.previewPiOrder.totalAmount * this.state.previewPiOrder.sgst / 100).toFixed(2)}</h3>
   ...
   <tr>
     ...
     <td>
       {this.props.previewAndRaisePI?
            <h3 className="freightch snopi"><b>Expected Date of delivery:</b> <span className="edddate">{this.props.expectedDateOfDelivery}</span></h3>
              :
