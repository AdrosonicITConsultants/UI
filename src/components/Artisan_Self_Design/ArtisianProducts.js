...
class ArtisianProducts extends Component {
    ...
    componentDidMount(){
        ...
        TTCEapi.getArtisianProducts(parseInt(params.artisanId)).then((response)=>{
            ...
            {
                heading1 = response.data.data.artisanDetails[0].firstName; 
            }
            else{
                heading1 = response.data.data.artisanDetails[0].companyName; 
...
export default ArtisianProducts;