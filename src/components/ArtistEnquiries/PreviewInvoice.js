...
<td className="tdmarginleft">
     ...
     <h3 className="snopi gdwidth wraptext" style={{textAlign:"left"}}>
       {this.state.history ? 
       <>
       {this.state.previewPI.productHistory.tag}-{this.state.previewPI.productHistory.length?this.state.previewPI.productHistory.length:""}
       </>
       :
       <>
       {this.state.previewPI.product.tag} -{this.state.previewPI.product.length?this.state.previewPI.product.length:""}
       </>
         }  
       </h3>
     ...
     -Yarn: {this.state.yarns[this.state.previewPI.productHistory.warpYarnId-1]?this.state.yarns[this.state.previewPI.productHistory.warpYarnId-1].yarnDesc:""}X
      ...
      -Dye Used: {this.state.dyes[this.state.previewPI.productHistory.warpDyeId-1]?this.state.dyes[this.state.previewPI.productHistory.warpDyeId-1].dyeDesc:""} X
    ...
    <>
     ...
     {this.state.previewPI.productHistory.productCategoryDesc?this.state.previewPI.productHistory.productCategoryDesc:""} : {this.state.previewPI.productHistory.weight?this.state.previewPI.productHistory.weight:"NA"} <br/>
       
     </div>
     <br/>
     <p>-Dimension :</p>
     <div className="sbred wraptext">
     {this.state.previewPI.productHistory.productCategoryDesc?this.state.previewPI.productHistory.productCategoryDesc:""}: {this.state.previewPI.productHistory.length} 
     {this.state.previewPI.productHistory.width}
      <br/>
        ...
        <>  {this.state.previewPI.relProductName[0]}: {this.state.previewPI.productHistory.relProduct[0].length} x {this.state.previewPI.productHistory.relProduct[0].width}
         ...
         <p>-GSM Value : <span className="rcred">{this.state.previewPI.productHistory.productCategoryDesc?this.state.previewPI.productHistory.productCategoryDesc:""} {this.state.previewPI.productHistory.gsm? this.state.previewPI.productHistory.gsm:""}</span></p>
     ...
     {this.state.previewPI.product.productCategoryDesc}: {this.state.previewPI.product.weight?this.state.previewPI.product.weight:"NA"} <br/>
        ...
        <>  {this.state.previewPI.product.relProduct[0].productType?this.state.previewPI.product.relProduct[0].productType.productDesc:""}: {this.state.previewPI.product.relProduct[0].weight !=null?this.state.previewPI.product.relProduct[0].weight:"NA"}</>
          :
     ...
     {this.state.previewPI.product.width?this.state.previewPI.product.width:""}
      <br/>
         {this.state.previewPI.product.relProduct.length > 0?
        <>  {this.state.previewPI.product.relProduct[0].productType?this.state.previewPI.product.relProduct[0].productType.productDesc:""}: {this.state.previewPI.product.relProduct[0].length?this.state.previewPI.product.relProduct[0].length:""} 
        {this.state.previewPI.product.relProduct[0].length && this.state.previewPI.product.relProduct[0].width?"x":"" } {this.state.previewPI.product.relProduct[0].width?this.state.previewPI.product.relProduct[0].width:""}</>
         ...
         <p>-GSM Value : <span className="rcred">{this.state.previewPI.product.productCategoryDesc?this.state.previewPI.product.productCategoryDesc:""} {this.state.previewPI.product.gsm? this.state.previewPI.product.gsm:""}</span></p>
    ...
    -Yarn Count: {this.state.buyerCustomProduct?this.state.buyerCustomProduct.warpYarnCount:""} {this.state.buyerCustomProduct?this.state.buyerCustomProduct.weftYarnCount:"" && this.state.buyerCustomProduct.warpYarnCount ?"x":""} {this.state.buyerCustomProduct?this.state.buyerCustomProduct.weftYarnCount:""}
    ...
    <>
    <p className="RAcss">- Reed Count : <span className="rcred wraptext">
        {this.state.reedCounts[this.state.previewPI.buyerCustomProductHistory.reedCountId-1]?this.state.reedCounts[this.state.previewPI.buyerCustomProductHistory.reedCountId-1].count:""}</span></p>
     ...
     this.state.productCategories[this.state.previewPI.buyerCustomProductHistory.productTypeId-1].productDesc:""}:
      {this.state.previewPI.buyerCustomProductHistory.length?this.state.previewPI.buyerCustomProductHistory.length:""} 
     {this.state.previewPI.buyerCustomProductHistory.width?this.state.previewPI.buyerCustomProductHistory.width:""}
      <br/>
         {this.state.previewPI.buyerCustomProductHistory.relProduct.length > 0?
        <>  {this.state.previewPI.relProductName[0]?
          this.state.previewPI.relProductName[0]:""}: 
          {this.state.previewPI.buyerCustomProductHistory.relProduct[0]?
          this.state.previewPI.buyerCustomProductHistory.relProduct[0].length:""} x 
          {this.state.previewPI.buyerCustomProductHistory.relProduct[0]?this.state.previewPI.buyerCustomProductHistory.relProduct[0].width:""}
         </> :
          
          ""}
     </div>
         <p>-GSM Value : <span className="rcred">{this.state.previewPI.buyerCustomProductHistory?this.state.previewPI.buyerCustomProductHistory.productCategoryDesc:""}
          {this.state.previewPI.buyerCustomProductHistory.gsm? this.state.previewPI.buyerCustomProductHistory.gsm:""}</span></p>
    ...
    <p className="RAcss">- Reed Count : <span className="rcred wraptext">{this.state.buyerCustomProduct.reedCount?this.state.buyerCustomProduct.reedCount.count:"NA"}</span></p>
     <p>-Weight :</p>
     <div className="sbred wraptext">
     {this.state.buyerCustomProduct.productCategory?this.state.buyerCustomProduct.productCategory.productDesc:""}: {this.state.buyerCustomProduct.weight?this.state.buyerCustomProduct.weight:"NA"} <br/>
        
     {this.state.buyerCustomProduct.relProduct.length > 0?
        <>  
        {this.state.buyerCustomProduct.relProduct[0].productType?this.state.buyerCustomProduct.relProduct[0].productType.productDesc:""}: {this.state.buyerCustomProduct.relProduct[0].weight !=null?this.state.buyerCustomProduct.relProduct[0].weight:"NA"}</>
          :
     ...
     <p>-Dimension :</p>
     <div className="sbred wraptext">
     {this.state.buyerCustomProduct.productCategory?this.state.buyerCustomProduct.productCategory.productDesc:""}: XYZ <br/>
    
     {this.state.buyerCustomProduct.relProduct.length > 0?
        <>  {this.state.buyerCustomProduct.relProduct[0].productType?this.state.buyerCustomProduct.relProduct[0].productType.productDesc:""}: 
        {this.state.buyerCustomProduct.relProduct[0].length?this.state.buyerCustomProduct.relProduct[0].length:""} 
        {this.state.buyerCustomProduct.relProduct[0].length && this.state.buyerCustomProduct.relProduct[0].width?"x":"" } 
        {this.state.buyerCustomProduct.relProduct[0].width?this.state.buyerCustomProduct.relProduct[0].width:""}</>
          :
          
          ""}

     </div>
     <p>-GSM Value : <span className="rcred">{this.state.buyerCustomProduct.productCategory.productDesc?this.state.buyerCustomProduct.productCategory.productDesc:""} XYZ</span></p>
     ...
     <td >
     <p className="snopi wraptext">{this.state.previewPiOrder?this.state.previewPiOrder.hsn:""}</p>
     </td>
     <td >
     <p className="snopi wraptext">{this.state.previewPiOrder?this.state.previewPiOrder.quantity:""}</p>
     </td>
     <td>
     <p className="snopi rpu wraptext">₹{this.state.previewPiOrder?this.state.previewPiOrder.ppu:""}</p>
     </td>
     <td>
