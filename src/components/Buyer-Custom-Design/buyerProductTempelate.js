                ...
                render() {
                   return (
                     <React.Fragment>
                       ...
                       <Container>
                         <Row noGutters="true" noGutters={true}>
                           <div className="artistLanding">
                             ...
                             <Row noGutters="true" noGutters={true}>
                               ...
                               <Row noGutters="true" noGutters={true} className="mt30">
                                 <Col
                                   sm={{ size: "2" }}
                                   xs={{ size: "2" }}
                                   md={{ size: "2" }}
                               ...
                               <Row noGutters="true" noGutters={true} className="text-center">
                                 <Col
                                   sm={{ size: "12" }}
                                   xs={{ size: "12" }}
                                   md={{ size: "12" }}
                             ...
                             <Row noGutters="true" noGutters={true} className="mt60">
                               <Row noGutters="true" noGutters={true}>
                                 <Col
                            ...
                            <br></br>
                             ...
                             <Row noGutters="true" noGutters={true} className="mt60">
                               ...
                               <Row noGutters="true" noGutters={true} className="mt15">
                                 <Col
                                   sm={{ size: "1" }}
                                   xs={{ size: "1" }}
                                   md={{ size: "1" }}
                               ...
                               <Row noGutters="true" noGutters={true} className="">
                                 <Col
                                   sm={{ size: "3" }}
                                   xs={{ size: "3" }}
                                   md={{ size: "3" }}
                               ...
                               <Row noGutters="true" noGutters={true} className="mt100">
                                 <Col
                                   sm={{ size: "1" }}
                                   xs={{ size: "1" }}
                                   md={{ size: "1" }}
                         ...
                         {/* <ReactModal
                             ...
                             >
                                <div className="modalconfirm">
                                  <Row noGutters="true" noGutters={true} className="text-center font20">
