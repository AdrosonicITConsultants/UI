                            ...
                            <Row noGutters={true}>
                                <Col sm="9">
                                    ...
                                    <div noGutters={true} >
                                        ...
                                        <span className="leEnqspun"> / {this.state.yarns[item.openEnquiriesResponse.warpYarnId - 1 ]?this.state.yarns[item.openEnquiriesResponse.warpYarnId - 1 ].yarnDesc:""} 
                                         X  {this.state.yarns[item.openEnquiriesResponse.weftYarnId - 1 ]?this.state.yarns[item.openEnquiriesResponse.weftYarnId - 1 ].yarnDesc:""}  
