...
class Footer extends Component {
  ...
  componentDidMount () {
    ...
    this.setState({
      userId: data ? data.refRoleId : null
    });
  }
          ...
          {this.state.userId ? 
            ...
            <Container className='footerContainer'>
              {/* <Row noGutters={true}>
                ...
                <div style={{marginBottom: "20px"}}>18-01-21  <span style={{marginLeft: "5px"}}>V-8</span></div>
                </Col>
              </Row> */}
              <Row noGutters={true}>
...
<div className="footerblack ">
            <Container className='footerContainer'>
              {/* <Row noGutters={true}>
                <Col className="col-xs-12 text-center">
                <div style={{marginBottom: "20px"}}>18-01-21  <span style={{marginLeft: "5px"}}>V-8.1</span></div>
                </Col>
              </Row> */}
              <Row noGutters={true}>
                <Col md="4" sm="4" xs="4" className="text-center">
